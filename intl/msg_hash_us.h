...
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ROTATION_0,
   "Schermata 1"
   ) 
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ROTATION_90,
   "Schermata 2"
   ) 
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ROTATION_180,
   "Schermata 3"
   ) 
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ROTATION_270,
   "Schermata 4"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ROTATION_0_FLIP,
   "Schermata 5"
   ) 
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ROTATION_90_FLIP,
   "Schermata 6"
   ) 
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ROTATION_180_FLIP,
   "Schermata 7"
   ) 
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ROTATION_270_FLIP,
   "Schermata 8"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ORIENT_0,
   "Change Orientation 0°"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ORIENT_90,
   "Change Orientation 90°"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ORIENT_180,
   "Change Orientation 180°"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ORIENT_270,
