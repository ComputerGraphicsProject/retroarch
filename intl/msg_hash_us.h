...
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ROTATION_CCW,
   "Change Rotation Counterclockwise"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ROTATION_CW,
   "Change Rotation Clockwise"
   ) 
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ORIENT_CCW,
   "Change Orientation Counterclockwise"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ORIENT_CW,
