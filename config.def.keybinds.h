...
static const struct retro_keybind retro_keybinds_1[] = {
   ...
   { true, RARCH_CHANGE_ROTATION_CCW,     MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ROTATION_CCW,    RETROK_UNKNOWN,   NO_BTN, NO_BTN, 0, AXIS_NONE, AXIS_NONE, AXIS_NONE, NULL, NULL },
   { true, RARCH_CHANGE_ROTATION_CW,      MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ROTATION_CW,     RETROK_UNKNOWN,   NO_BTN, NO_BTN, 0, AXIS_NONE, AXIS_NONE, AXIS_NONE, NULL, NULL },
   { true, RARCH_CHANGE_ORIENT_CCW,       MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ORIENT_CCW,      RETROK_UNKNOWN,   NO_BTN, NO_BTN, 0, AXIS_NONE, AXIS_NONE, AXIS_NONE, NULL, NULL },
   { true, RARCH_CHANGE_ORIENT_CW,        MENU_ENUM_LABEL_VALUE_INPUT_META_CHANGE_ORIENT_CW,       RETROK_UNKNOWN,   NO_BTN, NO_BTN, 0, AXIS_NONE, AXIS_NONE, AXIS_NONE, NULL, NULL },
