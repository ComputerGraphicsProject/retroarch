...
enum
{
   ...
   RARCH_OSK,
   RARCH_FPS_TOGGLE,
   RARCH_CHANGE_ROTATION_0,
   RARCH_CHANGE_ROTATION_90,
   RARCH_CHANGE_ROTATION_180,
   RARCH_CHANGE_ROTATION_270,
   RARCH_CHANGE_ROTATION_0_FLIP,
   RARCH_CHANGE_ROTATION_90_FLIP,
   RARCH_CHANGE_ROTATION_180_FLIP,
   RARCH_CHANGE_ROTATION_270_FLIP,
   RARCH_CHANGE_ORIENT_0,
   RARCH_CHANGE_ORIENT_90,
   RARCH_CHANGE_ORIENT_180,
   RARCH_CHANGE_ORIENT_270,
   RARCH_SHADER_FLIP_VER,
   RARCH_SHADER_FLIP_OR,
   RARCH_SHADER_COCKTAIL,
